...
knitr::include_graphics("images/Women_in_Parliament_hex.png")
```
...
```{r Putting the Year variable into a column}
WP <- melt(wip,
...
```{r Making Year a numeric variable}
...
```{r France versus other European Union (EU) countries}
...
```{r Highest percentage by year and continent}
...
knitr::include_graphics("images/Women_in_Parliament_rect.png")
```
